...
Image.getImageData = function(data)
{
    ...
    imageData.data = new Buffer(ref.reinterpret(bits, (Math.ceil((this.width * this.bpp / 8) / 4) * 4) * this.height, 0));
    // Flip image
    imageData.data = imageData.data.slice((this.height - 1) * (this.width * 4), this.height * (this.width * 4));
