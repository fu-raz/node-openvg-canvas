...
Image.prototype.upload = function () {
    ...
    this._handle = vg.createImage(vg.VGImageFormat.VG_sARGB_8888, this.width, this.height, vg.VGImageQuality.VG_IMAGE_QUALITY_FASTER);
...
Image.drawImage = function (img, sx, sy, sw, sh, dx, dy, dw, dh, paintFn) {
    ...
    if (sx === 0 && sy === 0 && sw === img.width && sh === img.height) {
        ...
        var vgSubHandle = vg.createImage(vg.VGImageFormat.VG_sARGB_8888, sw, sh, vg.VGImageQuality.VG_IMAGE_QUALITY_FASTER);
